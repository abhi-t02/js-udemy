...
const displayMovements = function (acc = {}, sort = false) {
  ...
  movs.forEach(function (mov, i) {
    ...
    const date = formatDates(new Date(acc.movementsDates[i]));
...
const logoutTimer = () => {
  ...
  setInterval(() => {
    ...
    labelTimer.textContent = `${(minute + '').padStart(2, 0)} : ${(
      second + ''
    ).padStart(2, 0)}`;
    second--;
  }, 1000);
...
// to check how many days passed

// console.log(daysPassed(new Date('2020-07-26T12:01:20.894Z'), new Date()));
